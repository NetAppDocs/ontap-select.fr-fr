...
Sign in à l'interface utilisateur Web pour confirmer que l'utilitaire Deploy est disponible et effectuez la configuration initiale.
...
. S'il s'agit de la première fois que vous vous connectez et que vous n'avez pas installé le déploiement à l'aide de l'assistant disponible avec vCenter, fournissez les informations de configuration suivantes lorsque vous y êtes invité :
+
