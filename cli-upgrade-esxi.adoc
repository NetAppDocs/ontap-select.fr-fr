...
summary: 'Si vous utilisez ONTAP Select sur VMware ESXi, vous pouvez mettre à niveau le logiciel ESXi d"une version antérieure prise en charge vers ESXi 8.0 ou une version ultérieure. Avant la mise à niveau, il est important de comprendre le processus et de sélectionner la procédure appropriée.' 
---
= Mettez à niveau votre solution ONTAP Select vers VMware ESXi 8.0 ou une version ultérieure.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Si vous utilisez ONTAP Select sur VMware ESXi, vous pouvez mettre à niveau le logiciel ESXi d'une version antérieure prise en charge vers ESXi 8.0 ou une version ultérieure. Avant la mise à niveau, il est important de comprendre le processus et de sélectionner la procédure appropriée.
...
+
** ONTAP Select la taille du cluster
+
...
----
. Mettez à niveau l’hôte hyperviseur sur lequel ONTAP Select s’exécute vers ESXi 8.0 ou version ultérieure à l’aide de la procédure fournie par VMware.
