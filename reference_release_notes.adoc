...
Vous pouvez accéder au link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3332465["Notes de mise à jour de ONTAP Select 9.16.1"^] pour afficher les détails de la version actuelle.
