...
Vous pouvez accéder aulink:https://library.netapp.com/ecm/ecm_download_file/ECMLP3365264["Notes de version ONTAP Select 9.18.1"^] pour consulter les détails concernant la version actuelle.
