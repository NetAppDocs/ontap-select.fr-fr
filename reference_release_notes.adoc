...
Vous pouvez accéder au link:https://library.netapp.com/ecm/ecm_download_file/ECMLP3378465["Notes de version d'ONTAP Select 9.19.1"^] pour consulter les détails concernant la version actuelle.
