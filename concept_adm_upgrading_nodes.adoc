...
. Mettez à niveau le nœud ONTAP Select en utilisant les procédures de mise à niveau ONTAP standard avec le fichier de mise à niveau ONTAP Select. Pour des informations sur les chemins de mise à niveau pris en charge, consultez le link:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html["Chemins de mise à niveau ONTAP pris en charge"^].
