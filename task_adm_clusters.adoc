...
. Sélectionnez image:icon_kebab.gif["Options"] à droite du cluster et sélectionnez *Mettre hors ligne*.
+
Si l'option hors ligne n'est pas disponible, le cluster est déjà à l'état hors ligne.

. Sélectionnez *Oui* dans la fenêtre contextuelle pour confirmer la demande.
. Sélectionnez *Actualiser* de temps en temps pour confirmer que le cluster est hors ligne.
. Pour remettre le cluster en ligne, sélectionnez image:icon_kebab.gif["Options"] et sélectionnez *Remettre en ligne*.
. Sélectionnez *Actualiser* de temps en temps pour confirmer que le cluster est en ligne.
...
. Connectez-vous à l'interface utilisateur Web de l'utilitaire de déploiement à l'aide du compte administrateur.
. Sélectionnez l'onglet *clusters* en haut de la page et sélectionnez le cluster souhaité dans la liste.
. Sélectionnez image:icon_kebab.gif["Options"] à droite du cluster et sélectionnez *Supprimer*.
+
Si l'option de suppression n'est pas disponible, le cluster n'est pas à l'état hors ligne.

. Sélectionnez *Actualiser* de temps en temps pour confirmer que le cluster est supprimé de la liste.
...
.Étapes
. Connectez-vous à l'interface utilisateur Web de l'utilitaire de déploiement à l'aide du compte administrateur.
. Sélectionnez l'onglet *Clusters* en haut à gauche de la page et sélectionnez le cluster souhaité dans la liste.
. Sélectionnez image:icon_kebab.gif["Options"] à droite de la page et sélectionnez *Actualisation du cluster*.
