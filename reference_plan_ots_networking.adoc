...
NOTE: Pour en savoir plus sur la configuration d'un vSwitch sur un hôte hyperviseur et sur la fonctionnalité d'interface haut débit, reportez-vous à la section link:concept_nw_concepts_chars.html["Présentation de la mise en réseau"].
...
Consultez la section link:concept_nw_concepts_chars.html["Présentation de la mise en réseau"] pour plus d'informations sur les déploiements à deux cartes réseau.
...
Consultez la section link:concept_nw_concepts_chars.html["Présentation de la mise en réseau"] pour plus d'informations sur les déploiements à quatre cartes réseau.
