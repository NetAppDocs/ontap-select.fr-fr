...
summary: 'NetApp ONTAP Select est un dispositif de stockage Software-defined que vous pouvez déployer sur divers serveurs matériels génériques exécutant l"hyperviseur VMware ESXi ou KVM (Kernel-based Virtual machine). Elle vous apporte l"agilité dont vous avez besoin pour concevoir une infrastructure de cloud privé flexible et évolutive. Ce site contient la documentation de ONTAP Select 9.16.1.' 
---
