...
ONTAP Select 9.13.1 peut être déployé sur VMware ESXi. Ce site contient la documentation pour ONTAP Select 9.13.1, 9.12.1, 9.11.1, 9.10.1, 9.9.1, les versions 9.8 et 9.7 s'exécutant sur VMware ESXi, ainsi que la documentation indépendante de l'hyperviseur (telle que l'API REST).
