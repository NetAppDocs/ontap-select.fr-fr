...
== Gestion des licences des tiers de capacité
...
== Gestion des licences du pool de capacité
...
== Réinstallation d'une licence de pool de capacité
...
+
Voir link:task_lic_acquire_cp.html["Acquisition d'une licence de pool de capacité"] pour en savoir plus.
...
== Conversion d'une licence d'évaluation en licence de production
...
.Avant de commencer
* Vous devez utiliser ONTAP Select 9.5P1 avec Deploy 2.11 ou version ultérieure
...
== Gestion d'une licence de pool de capacité expirée
