...
* La mise à niveau de licence est uniquement prise en charge par ONTAP Select 9.5P1 avec Deploy 2.11 ou version ultérieure
...
link:task_adm_licenses.html["Conversion d'une licence d'évaluation en licence de production"] pour en savoir plus.
