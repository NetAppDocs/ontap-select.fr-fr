...
ONTAP Select prend en charge les modèles de processeurs basés sur Intel Xeon Sandy Bridge et Advanced Micro Devices (AMD).

Reportez-vous à la  https://mysupport.netapp.com/matrix["Matrice d'interopérabilité"^] pour plus d'informations.
...
.Processeur
Les microprocesseurs compatibles incluent les processeurs serveur Intel Xeon et les processeurs AMD.

Consultez link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003["Processeurs Intel Xeon"^] et link:https://www.amd.com/en/products/processors/server/epyc.html["Processeurs serveurs AMD EPYC"^] pour plus d’informations.
...
Apprenez-en plus sur link:concept_lic_platforms.html["les offres de licences de plateforme pour ONTAP Select"]
