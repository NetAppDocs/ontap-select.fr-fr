...
--
Prise en charge de l'hyperviseur KVM mise à jour:: À partir de ONTAP Select 9.17.1, l'hyperviseur KVM est pris en charge sur Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7 et 9.6 et Rocky Linux 10.1, 10.0, 9.7 et 9.6.
+
--
[NOTE]
====
Il existe des limitations concernant le flux de travail RAID logiciel pour les hyperviseurs KVM sur les hôtes RHEL 10.1 et 10.0 et Rocky Linux 10.1 et 10.0. Pour plus d’informations, consultez les articles suivants de la Knowledge Base :
