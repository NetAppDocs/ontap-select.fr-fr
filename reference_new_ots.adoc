...
--
Prise en charge de l'hyperviseur KVM mise à jour:: À partir d'ONTAP Select 9.17.1, l'hyperviseur KVM est pris en charge sur Red Hat Enterprise Linux (RHEL) 10.1, 10.0, 9.7 et 9.6 et Rocky Linux 10.0 et 9.6.
+
--
[NOTE]
====
