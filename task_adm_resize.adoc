...
. Sélectionnez l'onglet *Cluster* en haut de la page, puis sélectionnez le cluster souhaité dans la liste.
. Sur la page de détails du cluster, sélectionnez l'icône d'engrenage à droite de la page et sélectionnez *Redimensionnement de l'instance*.
. Sélectionnez le *Type d'instance* et fournissez les identifiants ONTAP, puis sélectionnez *Modifier*.
