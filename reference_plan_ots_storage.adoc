...
NOTE: Si un contrôleur RAID matériel est présent, reportez-vous à la section link:concept_stor_concepts_chars.html["Stockage de plongée en profondeur"] pour les exigences de configuration supplémentaires.
