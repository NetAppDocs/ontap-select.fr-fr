...
.Étapes
. Sur la page principale, faites défiler vers le bas et sélectionnez *Cluster*.
. Sélectionnez *GET /clusters/{cluster_id}* pour afficher les détails de l'appel API utilisé pour renvoyer des informations sur un cluster ONTAP Select.
