...
Pour en savoir plus sur la configuration d'un Open vSwitch sur un hôte hyperviseur, consultez le link:https://www.netapp.com/media/13134-tr4613.pdf["Architecture des produits ONTAP Select sur KVM et meilleures pratiques"^] rapport technique.
