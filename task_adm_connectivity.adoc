...
. Sélectionnez l'onglet *Administration* en haut de la page, puis sélectionnez *Network Checker*.
. Sélectionnez *Démarrer une nouvelle exécution*, puis sélectionnez les hôtes et les réseaux pour la paire haute disponibilité
+
Vous pouvez ajouter et configurer des paires haute disponibilité supplémentaires selon vos besoins.

. Sélectionnez *Démarrer* pour lancer le test de connectivité réseau.
