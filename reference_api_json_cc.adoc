...
NOTE: Depuis la version ONTAP Select 9.10.1, l'hyperviseur KVM n'est plus pris en charge lors de la création de nouveaux clusters. L'exemple ci-dessous s'applique aux versions antérieures prenant en charge KVM.
