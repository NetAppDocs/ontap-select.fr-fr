...
.Étapes
. Accédez au site d'assistance NetApp à l'aide d'un navigateur Web et sélectionnez *Liens rapides d'assistance*.
. Sélectionnez *Télécharger le logiciel* sous *Tâches principales* et connectez-vous au site.
. Sélectionnez *Trouver votre produit*.
. Faites défiler vers le bas et sélectionnez *ONTAP Select*.
. Sous *Autres logiciels disponibles*, sélectionnez *Déploiement, mise à niveau du nœud, installation d'image*.
