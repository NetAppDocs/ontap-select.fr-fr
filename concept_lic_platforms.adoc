...
NOTE: L'utilisation du type d'instance volumineuse dans une configuration RAID logicielle n'est pas prise en charge sur une machine virtuelle basée sur le noyau (KVM).
