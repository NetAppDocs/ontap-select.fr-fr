...
Les licences standard, premium et premium XL sont compatibles avec une large gamme de matériels et de logiciels. Pour des informations à jour sur les versions matérielles et logicielles, consultez le link:https://mysupport.netapp.com/matrix/["Matrice d'interopérabilité"^].
...
*Remarque* : Le flux de travail RAID logiciel présente des limitations pour les hyperviseurs KVM sur RHEL 10.1 et 10.0 et Rocky Linux 10.0. Pour plus d’informations, consultez les articles suivants de la base de connaissances :
