...
2+| Famille CPU  a| 
Intel Xeon E5-26xx v3 (Haswell) ou ultérieur

AMD EPYC Embedded 9004 ou version ultérieure et 8004
 a| 
Intel Xeon E5-26xx v3 (Haswell) ou ultérieur
...
Apprenez-en plus sur link:concept_lic_workflow.html["achat d'une licence ONTAP Select"]
