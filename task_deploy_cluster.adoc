...
Après le déploiement du cluster, vérifiez que la fonctionnalité ONTAP Select AutoSupport est configurée, puislink:task_cli_clusters.html["Sauvegardez les données de configuration de déploiement ONTAP Select"] .
