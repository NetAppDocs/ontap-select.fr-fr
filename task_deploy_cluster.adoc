...
.Étapes
Les étapes à suivre varient selon que vous souhaitez créer un cluster à nœud unique ou à nœuds multiples. Un cluster multi-nœuds peut comporter deux, quatre, six, huit, dix ou douze nœuds.
