...
NOTE: L'API REST incluse dans ONTAP Select Deploy possède un numéro de version. Le numéro de version de l'API est indépendant du numéro de version de Deploy. L'utilitaire d'administration ONTAP Select Deploy 9.19.1 inclut la version 3 de l'API REST.
